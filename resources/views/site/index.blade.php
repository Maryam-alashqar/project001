            ...
            <div class="trending-main">
                ...
                <div class="row">
                        ...
                        <div class="trending-bottom">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        <div class="trend-bottom-img mb-30">
                                            <img src={{ asset('siteassets//img/trending/trending_bottom2.jpg') }} alt="">
                                        </div>
                                        <div class="trend-bottom-cap">
                                ...
                                <div class="col-lg-4">
                                    <div class="single-bottom mb-35">
                                        <div class="trend-bottom-img mb-30">
                                            <img src={{ asset('siteassets//img/trending/trending_bottom3.jpg') }} alt="">
                                        </div>
                                        <div class="trend-bottom-cap">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src={{ asset('siteassets//img/trending/right2.jpg') }} alt="">
                            </div>
                            <div class="trand-right-cap">
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src={{ asset('siteassets//img/trending/right3.jpg') }} alt="">
                            </div>
                            <div class="trand-right-cap">
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src={{ asset('siteassets//img/trending/right4.jpg') }} alt="">
                            </div>
                            <div class="trand-right-cap">
                        ...
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src={{ asset('siteassets//img/trending/right5.jpg') }} alt="">
                            </div>
                            <div class="trand-right-cap">
